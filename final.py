...
explosion = pygame.image.load(('explosion_blue.png'))

# load sounds

#Missile sound
missile_sound = pygame.mixer.Sound(os.path.join('missile.ogg'))
missile_sound.set_volume(1)

#thrust sound
thruster_sound = pygame.mixer.Sound(os.path.join('thrust.ogg'))
thruster_sound.set_volume(1)

#thrust sound
explosion_sound = pygame.mixer.Sound(os.path.join('explosion.ogg'))
explosion_sound.set_volume(1)

#background score
pygame.mixer.music.load(os.path.join('game.ogg'))
